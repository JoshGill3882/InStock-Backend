...
public class User {
    ...
    public User(string userId, string email, string accountStatus, long creationDate, string firstName, string lastName, string password, string role, string businessId, string refreshToken, string refreshTokenExpiry, string? imageFilename) {
        UserId = userId;
        Email = email;
    ...
    public User(UserDto userDto) {
        ...
        ImageFilename = userDto.ImageFilename;
    }
}